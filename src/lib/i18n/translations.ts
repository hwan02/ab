...
const translations = {
  ...
  "faq.questionPlaceholder": {
    ko: "자주 묻는 질문을 입력하세요",
    en: "Enter a frequently asked question",
    ja: "よくある質問を入力してください",
    zh: "输入常见问题",
  },
  "faq.answerLabel": {
  ...
  "reviews.placeholder": {
    ko: "포포스테이에서의 추억이나 감상을 자유롭게 적어주세요...",
    en: "Share your memories and thoughts about your stay...",
    ja: "滞在の思い出や感想を自由に書いてください...",
    zh: "请自由分享您住宿的回忆和感想...",
  },
  "reviews.submit": {
    ko: "등록",
  ...
  "reviews.noReviewsDesc": {
    ko: "첫 번째 방명록을 남겨보세요!",
    en: "Be the first to leave a message!",
    ja: "最初の投稿をしましょう！",
    zh: "成为第一个留言的人！",
  },
  "reviews.anonymous": {
  ...
  "podong.subtitle": {
    ko: "귀여운 포동이를 만나보세요!",
    en: "Meet our cute hamster Podong!",
    ja: "かわいいポドンに会いましょう！",
    zh: "来认识可爱的布丁吧！",
  },
  "podong.hostTitle": {
    ko: "포동이 사진첩 관리",
    en: "Manage Podong Gallery",
    ja: "ポドンギャラリー管理",
    zh: "管理布丁相册",
  },
  "podong.hostSubtitle": {
    ko: "포동이 사진을 업로드하고 관리하세요",
    en: "Upload and manage Podong photos",
    ja: "ポドンの写真をアップロード・管理",
    zh: "上传和管理布丁的照片",
  },
  "podong.addPhoto": {
  ...
  "podong.captionPlaceholder": {
    ko: "사진에 대한 설명을 입력하세요",
    en: "Add a caption for this photo",
    ja: "写真の説明を入力してください",
    zh: "请输入照片说明",
  },
  "podong.noPhotos": {
  ...
  "podong.noPhotosHostDesc": {
    ko: "포동이 사진을 업로드해주세요",
    en: "Upload some photos of Podong",
    ja: "ポドンの写真をアップロードしてください",
    zh: "请上传布丁的照片",
  },
  "podong.noPhotosGuestDesc": {
    ko: "호스트가 곧 사진을 올려줄 거예요",
    en: "The host will upload photos soon",
    ja: "ホストがまもなく写真をアップロードします",
    zh: "房东即将上传照片",
  },
  "podong.uploadFailed": {
    ko: "사진 업로드에 실패했습니다",
  ...
  "podong.loginToComment": {
    ko: "댓글을 남기려면 로그인해주세요",
    en: "Please log in to leave a comment",
    ja: "コメントするにはログインしてください",
    zh: "请登录后留言",
  },
  "podong.noComments": {
    ko: "아직 댓글이 없어요",
  ...
  "guide.hostTitle": {
    ko: "상세 가이드 관리",
    en: "Manage Detailed Guides",
    ja: "詳細ガイド管理",
    zh: "管理详细指南",
  },
  "guide.hostSubtitle": {
    ko: "사진/영상이 포함된 상세 가이드를 등록하세요",
    en: "Add detailed guides with photos and videos",
    ja: "写真や動画付きの詳細ガイドを登録しましょう",
    zh: "添加包含照片和视频的详细指南",
  },
  "guide.addGuide": {
    ko: "가이드 추가",
  ...
  "guide.guideNamePlaceholder": {
    ko: "예: 보일러 사용법",
    en: "e.g. How to use the boiler",
    ja: "例：ボイラーの使い方",
    zh: "例：锅炉使用方法",
  },
  "guide.description": {
  ...
  "guide.descriptionPlaceholder": {
    ko: "자세한 사용 방법을 입력하세요",
    en: "Enter detailed instructions",
    ja: "詳しい使い方を入力してください",
    zh: "请输入详细说明",
  },
  "guide.category": {
  ...
  "guide.mediaHint": {
    ko: "이미지(10MB) 또는 영상(50MB)을 업로드하세요",
    en: "Upload an image (10MB) or video (50MB)",
    ja: "画像(10MB)または動画(50MB)をアップロード",
    zh: "上传图片(10MB)或视频(50MB)",
  },
  "guide.noGuides": {
    ko: "등록된 가이드가 없습니다",
    en: "No guides yet",
  ...
  "guide.noGuidesHostDesc": {
    ko: "상세 가이드를 추가해주세요",
    en: "Add a detailed guide for your guests",
    ja: "ゲストのために詳細ガイドを追加してください",
    zh: "请为您的客人添加详细指南",
  },
  "guide.saveFailed": {
    ko: "저장에 실패했습니다",
